        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="#contact" className="px-4 py-2 bg-gradient-to-r from-red-500 to-green-500 text-white rounded-lg hover:opacity-90 transition-opacity">Get the App</a>
            </div>
          </nav>
        </div>
      </header>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="grid lg:grid-cols-2 gap-12 items-center py-16 sm:py-24">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl sm:text-2xl text-gray-700 max-w-3xl mb-12 leading-relaxed animate-fade-in-up animation-delay-200">
                  Connect with your neighbors to share homemade meals and reduce food waste.
                  Join the P2P food revolution today!
                </p>

                <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start items-center animate-fade-in-up animation-delay-400">
              ...
              <div className="relative flex justify-center lg:justify-end">
                {/* glow */}
                <div className="absolute w-[420px] h-[420px] bg-green-500/20 blur-3xl rounded-full -z-10" />

                {/* first image (back) */}
                <img
                  src={phone1}
                  alt="App screenshot 1"
                  className="relative z-20 w-[240px] rounded-3xl shadow-2xl"
                />

                {/* second image (front & upper) */}
                <img
                  src={phone2}
                  alt="App screenshot 2"
                  className="absolute top-[-40px] right-50 w-[240px] rounded-3xl shadow-2xl"
                />
              </div>
